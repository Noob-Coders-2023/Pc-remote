...
label = tkinter.Label(root, text="\n\nControl your PC with Telegram Bot\nLotfan tamam fields kamil konid!\n\nBot Token:")
token = tkinter.Entry(root, width=50)
labol = tkinter.Label(root, text='Owner\'s username without @:')
owner = tkinter.Entry(root)
labul = tkinter.Label(root, text="zaban shoma?! (en):")
...
label4 = tkinter.Label(root, text="\n\nPowered by github.com/mahmoud-samsami")
